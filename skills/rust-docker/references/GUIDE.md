...
This guide provides comprehensive documentation for the **rust-docker** skill in the custom-plugin-rust plugin.
...
```bash
# Invoke the skill
claude "rust-docker - [your task description]"

# Example
claude "rust-docker - analyze the current implementation"
```
...
def implement_rust_docker(input_data):
    """
    Implement rust-docker functionality.
