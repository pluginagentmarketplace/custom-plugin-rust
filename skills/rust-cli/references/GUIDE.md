...
This guide provides comprehensive documentation for the **rust-cli** skill in the custom-plugin-rust plugin.
...
```bash
# Invoke the skill
claude "rust-cli - [your task description]"

# Example
claude "rust-cli - analyze the current implementation"
```
...
def implement_rust_cli(input_data):
    """
    Implement rust-cli functionality.
