...
This guide provides comprehensive documentation for the **rust-macros** skill in the custom-plugin-rust plugin.
...
```bash
# Invoke the skill
claude "rust-macros - [your task description]"

# Example
claude "rust-macros - analyze the current implementation"
```
...
def implement_rust_macros(input_data):
    """
    Implement rust-macros functionality.
