...
This guide provides comprehensive documentation for the **rust-concurrency** skill in the custom-plugin-rust plugin.
...
```bash
# Invoke the skill
claude "rust-concurrency - [your task description]"

# Example
claude "rust-concurrency - analyze the current implementation"
```
...
def implement_rust_concurrency(input_data):
    """
    Implement rust-concurrency functionality.
