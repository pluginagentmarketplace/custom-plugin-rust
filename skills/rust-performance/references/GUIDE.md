...
This guide provides comprehensive documentation for the **rust-performance** skill in the custom-plugin-rust plugin.
...
```bash
# Invoke the skill
claude "rust-performance - [your task description]"

# Example
claude "rust-performance - analyze the current implementation"
```
...
def implement_rust_performance(input_data):
    """
    Implement rust-performance functionality.
