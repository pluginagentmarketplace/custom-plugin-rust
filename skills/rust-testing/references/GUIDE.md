...
This guide provides comprehensive documentation for the **rust-testing** skill in the custom-plugin-rust plugin.
...
```bash
# Invoke the skill
claude "rust-testing - [your task description]"

# Example
claude "rust-testing - analyze the current implementation"
```
...
def implement_rust_testing(input_data):
    """
    Implement rust-testing functionality.
